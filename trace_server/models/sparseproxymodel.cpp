...
// { }
// 
// bool SparseProxyModel::filterAcceptsIndex (QModelIndex const & sourceIndex, QModelIndex const & /*sourceParent*/) const
// {
// 	bool is_empty = true;
// 	for (int i = 0, ie = sourceModel()->columnCount(); i < ie; ++i)
// 	{
// 		QModelIndex const data_idx = sourceModel()->index(sourceIndex.row(), i, QModelIndex());
...
// // }
// 
// bool SparseFilterProxyModel::filterAcceptsIndex (QModelIndex const & sourceIndex, QModelIndex const & sourceParent) const
// {
// 	return false;
// }
// 
