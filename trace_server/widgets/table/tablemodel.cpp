...
void TableModel::commitCommands (std::vector<DecodedCommand> const & dcmds, E_ReceiveMode mode)
{
	//commitBatchToModel(m_batch);
}

// void TableModel::handleCommand(DecodedCommand const & cmd, E_ReceiveMode mode)
// {
...
// 	{
// 		case proto::cmd_table_xy:			handleTableXYCommand(cmd, mode); break;
// 		case proto::cmd_table_setup:		handleTableSetupCommand(cmd, mode); break;
// 		case proto::cmd_table_clear:		handleTableClearCommand(cmd, mode); break;
// 	}
// }
...
{
// 	QString tag;
// 	if (!cmd.getString(proto::tag_msg, tag)) return true;
// 	QString ctime;
// 	if (!cmd.getString(proto::tag_ctime, ctime)) return true;
// 	int x = 0;
// 	if (!cmd.get(proto::tag_ix, x)) return true;
// 	int y = 0;
// 	if (!cmd.get(proto::tag_iy, y)) return true;
// 	QString fgc;
// 	cmd.getString(proto::tag_fgc, fgc);
// 	QString bgc;
// 	cmd.getString(proto::tag_bgc, bgc);
//
...
// 	cmd.getString(proto::tag_bgc, bgc);
// 	QString hhdr;
// 	cmd.getString(proto::tag_hhdr, bgc);
// 
...
{
// 	QString msg;
// 	if (!cmd.getString(proto::tag_msg, msg)) return true;
// 
// 	QString tag = msg;
