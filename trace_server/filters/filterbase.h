...
static_assert(e_filtertype_max_value + 1 == sizeof(g_filterNames) / sizeof(*g_filterNames), "forgot something");
...
//	virtual bool accept (QModelIndex const & sourceIndex) const = 0;
//	virtual bool action (QModelIndex const & sourceIndex) { return true; }
	virtual bool accept (QModelIndex const & idx) { return true; }
